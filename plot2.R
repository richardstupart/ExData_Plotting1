...
#Create plot 2
png("plot2.png")
plot(strptime(paste(as.character(allData$Date), ' ', as.character(allData$Time)), format = "%Y-%m-%d %H:%M:%S"), allData$Global_active_power, type="l", xlab = "", ylab = "Global Active Power (kilowatts)")
dev.off()
